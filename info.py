...
BOT_TOKEN = environ.get('BOT_TOKEN', '6154129452:AAHrfphvTJSS1gnyzlVl08x1n9oPEoHEPto')
...
# Bot Admins
ADMINS = [int(admins) if id_pattern.search(admins) else admins for admins in environ.get('ADMINS', '1030188110').split()]
auth_users = [int(auth_users) if id_pattern.search(auth_users) else auth_users for auth_users in environ.get('AUTH_USERS', '1030188110').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# Channels
INDEX_CHANNELS = [int(index_channels) if id_pattern.search(index_channels) else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1001944388469').split()]
auth_channel = environ.get('AUTH_CHANNEL', 'auth321')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001926449115'))

# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://technical:technical@cluster0.qqyb9zi.mongodb.net/?retryWrites=true&w=majority")
